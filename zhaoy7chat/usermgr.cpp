...
void UserMgr::AppendFriendChatMsg(int friend_id, std::vector<std::shared_ptr<TextChatData>> msg)
{
...
UserMgr::UserMgr()
    :_user_info(nullptr), _chat_loaded(0),_contact_loaded(0)/*, _last_chat_thread_id(0),_cur_load_chat_index(0)*/
{
